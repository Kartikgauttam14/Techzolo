    ...
    <html lang="en" suppressHydrationWarning>
      ...
      <body className={`font-sans ${GeistSans.variable} ${GeistMono.variable}`}>
          ...
          <div className="w-full px-4 sm:px-6 lg:px-8">
            <div className="flex items-center justify-between h-16 max-w-7xl mx-auto">
              ...
              <nav className="hidden md:flex items-center space-x-8 flex-1 justify-center">
                <Link to="/dashboard" className="text-white/90 hover:text-white transition-all duration-200 font-medium whitespace-nowrap hover:scale-105">Dashboard</Link>
                <Link to="/domain-search" className="text-white/90 hover:text-white transition-all duration-200 font-medium whitespace-nowrap hover:scale-105">Domain Search</Link>
                <Link to="/profile" className="text-white/90 hover:text-white transition-all duration-200 font-medium whitespace-nowrap hover:scale-105">Profile</Link>
              </nav>
        ...
        <main className="min-h-screen pt-16">
          {/* Wrapped children with AuthProvider for global auth state */}
          <AuthProvider>
            <NetworkStatus />
            {children}
          </AuthProvider>
